...
class QuadTree {
	 ...
	 *            The maximum gap between two Nodes which makes them neighbours
	 */
	...
	/**
	 * The maximum distance between two {@code ActionGroups} at which they are considered neighbours,
